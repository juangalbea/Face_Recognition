...
To ensure compatibility, use Node.js version 22 or above when running the available scripts. Using an incompatible version may lead to unexpected behavior.
